package minipbl;
import controller.Lapor;
import javax.swing.JOptionPane;
import java.awt.Color;

public class FormLapor2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Form Laporan Kerusakan");
        ...
        jLabel5.setText("Form Laporan Kerusakan");
        PTrans.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 0, -1, -1));

        jLabel3.setFont(new java.awt.Font("Rockwell", 0, 12)); // NOI18N
        jLabel3.setText("ID Ruangan");
        PTrans.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 100, -1, -1));

        jLabel6.setFont(new java.awt.Font("Rockwell", 0, 12)); // NOI18N
        jLabel6.setText("Detail Kerusakan");
        PTrans.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, -1, -1));
        ...
        PTrans.add(txtruang2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 100, 50, -1));
        ...
        PTrans.add(btnajukan, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 240, -1, -1));

        txtdetail.setColumns(20);
        txtdetail.setRows(5);
        jScrollPane1.setViewportView(txtdetail);

        PTrans.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 140, -1, -1));
    ...
    private void btnajukanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnajukanActionPerformed
        Lapor inp = new Lapor();
        inp.id_ruangan = txtruang2.getText();
        inp.detail_rusak = txtdetail.getText();
        try{
            inp.report();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormLapor2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormLapor2().setVisible(true);
            }
        });
    }
